...
const BLOG_POSTS = [
    {
        ...
        content: `
            ...
            <p>Современные сервисы, такие как Build App AI, используют нейросети для проверки смет. ИИ сравнивает ваши цены с рыночными и подсказывает, если вы что-то упустили.</p>
        `
    },
    {
        id: '2',
